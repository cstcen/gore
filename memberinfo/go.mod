module github.com/cstcen/gore/memberinfo

go 1.20

require (
	github.com/cstcen/gore/db/cache v0.11.1-beta.10
	github.com/cstcen/gore/gonfig v0.11.1-beta.37
	github.com/cstcen/gore/http v0.11.1-beta.42
...
require (
	...
	github.com/cstcen/gore/log v0.11.1-beta.1 // indirect
