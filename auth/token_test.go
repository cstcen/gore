...
func Test_deleteCheckCache(t *testing.T) {
	type args struct {
		token string
	}
	tests := []struct {
		...
		{name: "deleteCheckCache", args: args{token: "da240119c5acebe28b4d8b231deabc613f56b58ecae1242eba86175e50a18b87f0178a0b42618f0543eafa1af2db2f3c127ec1fe6bf5e03aa2aa4f134e5bf22ae5f579f9ac8ab7afa7f045f6abdc7650dc691a6d00daa1a395881e5dd8122b6b"}, wantErr: assert.NoError},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.wantErr(t, deleteCheckCache(tt.args.token), fmt.Sprintf("deleteCheckCache(%v)", tt.args.token))
		})
	}
}
