module github.com/cstcen/gore/infratoken

go 1.20

require (
	github.com/cstcen/gore/gonfig v0.11.1-beta.1
	github.com/cstcen/gore/http v0.11.1-beta.1
	github.com/cstcen/gore/log v0.11.1-beta.1
